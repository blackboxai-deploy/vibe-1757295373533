...
function generateQuestionsFromTemplates(params: QuestionRequest): Question[] {
  ...
  for (const habilidade of params.habilidades) {
    ...
    const difficultyTemplates = habilidadeTemplates[params.dificuldade];
...
function generateRandomValues(disciplina: string, habilidade: string, dificuldade: string): Record<string, any> {
